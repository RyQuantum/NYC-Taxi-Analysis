...
public class HourlyEfficiencyMapper extends
	...
	public void map(LongWritable key, Text value, Context context)
		...
		if(tripTimeInSec == 0 || line.length < 19) {
			return;
		}
		double money = Double.parseDouble(line[18]);
		double efficiency = money / tripTimeInSec;
...
//			return;
//		}
		outValue.set(efficiency +","+ value.toString());
